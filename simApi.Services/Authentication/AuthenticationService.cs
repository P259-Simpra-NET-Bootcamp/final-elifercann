...
public class AuthenticationService : IAuthenticationService
{
    ...
    public AuthenticationService(IMapper mapper, UserManager<User2> userManager, IConfiguration configuration, ILoggerService logger)
    {
        _mapper = mapper;
    ...
    {
        var user = _mapper.Map<User2>(userForRegister);

        var result = await _userManager
            .CreateAsync(user, userForRegister.Password);
    ...
    public async Task<bool> ValidateUser(UserForAuthenticationResponse userForAuthDto)
    {
    ...
    public async Task<TokenDto> RefreshToken(TokenDto tokenDto)
    {
        ...
        if (user is null ||
            ...
            return new TokenDto();//hata mesajı ekle
